...
/** @var app\models\BuildingWorkerSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Building Workers';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="building-worker-index">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a('Create Building Worker', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                'attribute' => 'name',
                'filter' => Html::input('text', $searchModel->formName() . '[name]', $searchModel->name, ['class' => 'form-control']),
            ],
            [
                'attribute' => 'range',
                'filter' => Html::input('number', $searchModel->formName() . '[range]', $searchModel->range, ['class' => 'form-control']),
            ],
            'description:ntext',
            [
            ...
            [
                ...
                'urlCreator' => function ($action, BuildingWorker $model, $key, $index, $column) {
